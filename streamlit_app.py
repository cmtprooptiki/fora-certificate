...
def main():
    ...
    html_logo ="<img style='display:block; margin-left:auto; margin-right:auto; text-align:center;' src='https://api.healthcare-management.gr/uploads/foralogo_ed7b7dceaa.png'  width=380 >"
